...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1033-erd-s-problem-1033-c8f65615-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1033"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1033-erd-s-problem-1033-c8f65615-v1",
      "problem_contract_sha256": "fc61408fcebf3cb448bace101d93fed0d225007cae09fe560db6217076d47bc0",
      "problem_id": "problem:um-ep-1033-erd-s-problem-1033-c8f65615",
      "route_id": "route:um-ep-1033-erd-s-problem-1033-c8f65615-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1033-erd-s-problem-1033-c8f65615-source-fidelity-01",
      "graph_id": "graph:um-ep-1033-erd-s-problem-1033-c8f65615-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1033-erd-s-problem-1033-c8f65615-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1033-erd-s-problem-1033-c8f65615-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $h(n)$ be such that every graph on $n$ vertices with $>n^2/4$ many edges contains a triangle whose vertices have degrees summing to at least $h(n)$. Estimate $h(n)$. In particular, is it true that $ h(n)\\geq (2(\\sqrt{3}-1)-o(1))n? $"
          },
          "statement_sha256": "526d179400378e10949708f972f987358502ea9e156bfc83bb6a0e10b58adfd6"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1033-erd-s-problem-1033-c8f65615-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1033-erd-s-problem-1033-c8f65615-root",
      "route_id": "route:um-ep-1033-erd-s-problem-1033-c8f65615-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1033-4c8917e1c93e",
        "url": "https://www.unsolvedmath.com/problems/EP-1033"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
